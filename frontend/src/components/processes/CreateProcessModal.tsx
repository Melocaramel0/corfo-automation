...
export const CreateProcessModal: React.FC<CreateProcessModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-corfoGray-0 rounded-lg shadow-xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
        {/* Header */}
        ...
        <div className="p-6 overflow-y-auto max-h-[calc(90vh-140px)]">
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Nombre del Concurso */}
            <div>
              <label className="block text-sm font-medium text-corfoGray-80 mb-2">
                Nombre del Concurso
              </label>
              <input
                type="text"
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-corfo-500 focus:border-transparent ${
                  errors.nombreConcurso ? 'border-corfoRed-75' : 'border-corfoGray-40'
                }`}
              ...
              {errors.nombreConcurso && (
                <p className="mt-1 text-sm text-corfoRed-500">{errors.nombreConcurso}</p>
              )}
            </div>
            ...
            <div>
              ...
              <input
                type="url"
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-corfo-500 focus:border-transparent ${
                  errors.rutaFormulario ? 'border-corfoRed-75' : 'border-corfoGray-40'
                }`}
              ...
              {errors.rutaFormulario && (
                <p className="mt-1 text-sm text-corfoRed-500">{errors.rutaFormulario}</p>
              )}
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  type="text"
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-corfo-500 focus:border-transparent ${
                    errors.usuarioAcceso ? 'border-corfoRed-75' : 'border-corfoGray-40'
                  }`}
                ...
                {errors.usuarioAcceso && (
                  <p className="mt-1 text-sm text-corfoRed-500">{errors.usuarioAcceso}</p>
                )}
              </div>
              ...
              <div>
                ...
                <input
                  type="password"
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-corfo-500 focus:border-transparent ${
                    errors.passwordAcceso ? 'border-corfoRed-75' : 'border-corfoGray-40'
                  }`}
                ...
                {errors.passwordAcceso && (
                  <p className="mt-1 text-sm text-corfoRed-500">{errors.passwordAcceso}</p>
                )}
              </div>
            </div>
            ...
            <div>
              ...
              <textarea
                rows={8}
                className="w-full px-3 py-2 border border-corfoGray-40 rounded-lg focus:ring-2 focus:ring-corfo-500 focus:border-transparent"
        ...
        {/* Footer */}
        <div className="flex justify-end space-x-3 p-6 border-t border-corfoGray-20">
          <button
            type="button"
            onClick={onClose}
            className="px-4 py-2 text-corfoGray-80 bg-corfoGray-20 hover:bg-corfoGray-40 rounded-lg transition-colors"
          >
            Cancelar
          </button>
          <button
