      ...
      <div className="flex items-center h-full">
        ...
        <div className="flex-1 flex items-center justify-between h-full px-4 lg:px-6">
          ...
          <div className="flex items-center space-x-4">
            ...
            {/* Notificaciones */}
            <button className="relative p-2 text-corfoGray-60 hover:text-corfoGray-80 focus:outline-none focus:text-corfoGray-80">
              <Bell className="h-5 w-5" />
              <span className="absolute top-1 right-1 block h-2 w-2 rounded-full bg-corfoRed-500"></span>
            </button>
