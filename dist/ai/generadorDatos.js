...
exports.generarValorCampo = generarValorCampo;
/**
 ...
 */
async function generarValorCampo(campo, configuracion, contexto) {
 ...
 */
function seleccionarOpcion(opciones, etiqueta) {
 ...
 */
function generarEmail(configuracion) {
 ...
 */
function generarTelefono(configuracion) {
    if (configuracion.preferenciasAutocompletado.usarDatosReales) {
 ...
 */
function generarNumero(etiqueta) {
 ...
 */
function generarFecha(etiqueta) {
    const hoy = new Date();
 ...
 */
function generarCheckbox(requerido) {
 ...
 */
function generarRadio(opciones) {
 ...
 */
function generarTexto(etiqueta, configuracion, esTextarea = false) {
